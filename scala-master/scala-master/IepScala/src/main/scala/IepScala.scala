...
object IepScala {
  ...
  def xmlOperationReadFromFile() = {
    ...
    val xmlData = XML.load("src/main/resources/test.xml")
    println(xmlData)
  ...
  def validateXML(): Unit = {
    ...
    val xsdFile = java.nio.file.Paths.get("src/main/resources/test.xsd")
    ...
    try {
      ...
      }.loadFile("src/main/resources/test.xml")
      inputStream.close()
    }catch {

      case ex: SAXParseException => println("Error" )
...
//  def validateXML2(): Unit = {
//
//    val xmlFile = java.nio.file.Paths.get("main/resources/test.xsd")
//    val xsdFile = java.nio.file.Paths.get("main/resources/test.xsd")
//    val  flag =ValidateXML.validate(String.valueOf(xmlFile),String.valueOf(xsdFile))
//    println(flag)
//
//  }

  def afterValidate(): Unit = {
    println("Probandooooo ")
  }
